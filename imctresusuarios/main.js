const USUARIOS = [
    { user: "pepito",   contra: "12345" },
    { user: "juanito",  contra: "67890" },
    { user: "julanito", contra: "00000" }
];
...
function iniciarSesion() {
    ...
    let acceso = USUARIOS.some(function(credencial) {
        return u === credencial.user && c === credencial.contra;
    });

    if (acceso) {
        // Credenciales correctas → mostrar calculadora
